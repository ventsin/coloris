...
namespace nana
{
	...
	public:
			...
			: form(owner, API::make_center(owner, 500, 300), appear::decorate<>())
		{
			...
			desc_.bgcolor(nana::color(50, 50, 50));
			desc_.fgcolor(nana::color(200, 200, 200));

			auto desc_extent = desc_.measure(470);

			btn_ok_.create(*this);
			btn_ok_.i18n(i18n_eval("NANA_BUTTON_OK"));
			btn_ok_.scheme().activated = nana::color(218, 165, 32);
			btn_ok_.scheme().background = nana::color(40, 40, 40);
			btn_ok_.scheme().foreground = nana::color(200, 200, 200);
			btn_ok_.edge_effects(false);
			...
			btn_cancel_.scheme().activated = nana::color(218, 165, 32);
			btn_cancel_.scheme().background = nana::color(40, 40, 40);
			btn_cancel_.scheme().foreground = nana::color(200, 200, 200);
			btn_cancel_.edge_effects(false);
	...
	window inputbox::integer::create(window parent, unsigned label_px)
	{
		...
		impl->label.bgcolor(nana::color(50, 50, 50));
		impl->label.fgcolor(nana::color(200, 200, 200));
	...
	window inputbox::text::create(window parent, unsigned label_px)
	{
		...
		if (impl->options.empty())
		{
			...
			//impl->textbox.bgcolor(nana::color(200, 200, 200));
			//impl->textbox.fgcolor(nana::color(200, 200, 200));
			//impl->textbox.scheme().
		}
		else
		{
	...
	window inputbox::path::create(window wd, unsigned label_px)
	{
		...
		impl->label.caption(impl->label_text);
		impl->label.format(true);
		impl->label.bgcolor(nana::color(255, 0, 0));
	...
	bool inputbox::_m_open(std::vector<abstract_content*>& contents, bool modal)
	{
		...
		input_wd.bgcolor(nana::color(50, 50, 50)); //USER MADE
		input_wd.fgcolor(nana::color(200, 200, 200));

		Icon::get().applyIcon(input_wd.native_handle());
