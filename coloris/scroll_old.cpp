...
namespace nana
{
	namespace drawerbase
	{
		...
		//private:
			...
			{
				graph.rectangle(true, nana::color(62, 62, 62));
				...
				auto result = r.result();
				if (!result.empty())
					graph.rectangle(result, true, nana::color(62, 62, 62));
			}
			...
			void drawer::_m_button_frame(graph_reference graph, rectangle r, int state)
			{
				...
				::nana::color clr; //highlight
				switch(state)
				{
				case states::actived:
					clr = nana::color(158, 158, 158); break;
				case states::selected:
					clr = nana::color(200, 200, 200); break;
				default:
					clr = nana::color(104, 104, 104); break;
				}
